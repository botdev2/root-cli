...
internal static class Program
{
    ...
    private static void PrintHelp()
    {
        ...
        TermUi.KeyValue("config", "~/Library/Application Support/root-cli/");
        TermUi.KeyValue("mcp cfg", "~/Library/Application Support/root-cli/mcp-servers.json");
        ...
        TermUi.Hint("install: ./scripts/install-rootcli-alias.sh   then: rootcli here / login");
    }
